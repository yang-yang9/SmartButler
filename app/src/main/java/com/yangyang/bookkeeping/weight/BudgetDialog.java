...
public class BudgetDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelIv = findViewById(R.id.iv_dialog_budget_error);
        ensureBtn = findViewById(R.id.btn_dialog_budget_ensure);
        moneyEt = findViewById(R.id.et_dialog_budget);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_dialog_budget_error:
                cancel();  //取消对话框
                break;
